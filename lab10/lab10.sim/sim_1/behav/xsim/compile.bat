...
REM
REM Generated by Vivado on Fri Nov 28 11:45:29 +0800 2025
...
echo "xvlog --incr --relax -prj tetris_top_vlog.prj"
call xvlog  --incr --relax -prj tetris_top_vlog.prj -log xvlog.log
